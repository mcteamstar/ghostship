...
| **Wraith** | Recon and documentation operative — research, investigation, writing project docs; read-only over code, may write report files (`output/report.md`, `docs/*.md`) | `read grep glob shell web_search web_fetch` | none (adjacent — reads change context, doesn't edit it) |
