...
- [ ] 1.1 In `academy/orders/sdd.md`, in the Reconciliation phase Ghost task, replace the existing merge success and failure instructions (steps 3 and 4 of the Ghost task) with the updated resolution strategy:
...
- [ ] 2.1 Read the updated `sdd.md` reconciliation phase and confirm the resolution strategy, escalation criteria, and Admiral mail content are clearly described for Ghost
- [ ] 2.2 Run `openspec validate trn-140-sdd-parallel-ghost-merge` and confirm no errors
