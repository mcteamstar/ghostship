...
This was the root cause of ghostship appearing broken on WSL and of `host_memory_available_gb` reporting near-zero on vm23 (225MB `MemFree` vs 6.4GB `MemAvailable` with 6.5GB in buff/cache).
