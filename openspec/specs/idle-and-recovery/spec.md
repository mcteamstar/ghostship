...
- **THEN** the system restarts the container, waits for the gateway to become reachable, mints a new session cookie, updates the registry, and then forwards the original request
