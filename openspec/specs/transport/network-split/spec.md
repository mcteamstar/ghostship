# transport/network-split Specification
...
**GA_API_KEY** remains optional and is a separate concern — external client auth at the Caddy edge only. This requirement does not alter `GA_API_KEY` behaviour.
