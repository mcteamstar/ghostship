...
_UI_PORT_START="${GA_UI_PORT_RANGE_START:-64058}"
_UI_PORT_END=$(( _UI_PORT_START + ${GA_UI_PORT_RANGE_SIZE:-50} - 1 ))
...
services:
  ga-transport:
    ...
    ports:
      - "127.0.0.1:${PORT}:${PORT}"
      - "${GA_UI_PORT_RANGE_START:-64058}-${_UI_PORT_END}:${GA_UI_PORT_RANGE_START:-64058}-${_UI_PORT_END}"
    networks:
      - ga-net
    volumes:
      - ${DATA_DIR}:/data
    ...
    environment:
      ...
      GA_UI_PORT_RANGE_START: "${GA_UI_PORT_RANGE_START:-64058}"
